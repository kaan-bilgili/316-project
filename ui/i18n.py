...
TRANSLATIONS = {
    "en": {
        ...
        "inputs_paths_summary": "ZIP: {zip}  ·  Output: {output}",
        "inputs_paths_summary_empty": "No folder or output file selected",
        ...
        "eval_progress_none": "No student folders found after extraction.",
    ...
    "tr": {
        ...
        "inputs_paths_summary": "ZIP: {zip}  ·  Çıktı: {output}",
        "inputs_paths_summary_empty": "Klasör veya çıktı dosyası seçilmedi",
        ...
        "eval_progress_none": "Ayıklama sonrası öğrenci klasörü bulunamadı.",
